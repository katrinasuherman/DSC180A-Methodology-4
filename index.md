...
**Email**: <a href="mailto:ksuherman@ucsd.edu">ksuherman@ucsd.edu</a>
**Mentor**: Armin Schwartzman
**Section**: B14

## Quarter 2 brainstorming
...
I would be interested to examine ensemble methods and other predictive modeling techniques. I want to expand the investigation by using machine learning models that can predict clinical or cognitive qualities from cortical features after reproducing the spin test framework. These models could show which cortical regions or feature sets contribute more to the predictions and enable testing if integrating several structural or functional brain maps increases prediction accuracy.
